...
def main():
    ...
    # print(f"Building Default PachaSketches") 
    # # Build PachaSketch for Retail dataset
    # build_pacha_sketch_for_retail("../sketches/retail/retail_default.json.gz", delta, rel_eps, bloom_p, levels)

    # # Build PachaSketch for Bank Marketing dataset
    # build_pacha_sketch_for_bank("../sketches/bank/bank_default.json.gz", delta, rel_eps, bloom_p, levels)

    # # Build PachaSketch for Census dataset
    # build_pacha_sketch_for_census("../sketches/census/census_default.json.gz", delta, rel_eps, bloom_p, levels)

    # print(f"Default PachaSketches built successfully.")

    # Build Pacha Sketches with decreasing size
    probs = 2**np.arange(2,7)*0.005
    rel_epsilons = 2**np.arange(2,7) * 0.00025
